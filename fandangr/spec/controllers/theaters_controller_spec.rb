  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved theater as @theater" do
        ...
        post :create, {:theater => { "location" => "invalid value" }}, valid_session
        assigns(:theater).should be_a_new(Theater)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested theater" do
        ...
        Theater.any_instance.should_receive(:update_attributes).with({ "location" => "MyString" })
        put :update, {:id => theater.to_param, :theater => { "location" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the theater as @theater" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Theater.any_instance.stub(:save).and_return(false)
        put :update, {:id => theater.to_param, :theater => { "location" => "invalid value" }}, valid_session
        assigns(:theater).should eq(theater)
      end
