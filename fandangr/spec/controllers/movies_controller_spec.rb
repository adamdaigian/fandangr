...
describe MoviesController do
  ...
  let(:valid_attributes) { { "film" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved movie as @movie" do
        ...
        post :create, {:movie => { "film" => "invalid value" }}, valid_session
        assigns(:movie).should be_a_new(Movie)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested movie" do
        ...
        Movie.any_instance.should_receive(:update_attributes).with({ "film" => "MyString" })
        put :update, {:id => movie.to_param, :movie => { "film" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the movie as @movie" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Movie.any_instance.stub(:save).and_return(false)
        put :update, {:id => movie.to_param, :movie => { "film" => "invalid value" }}, valid_session
        assigns(:movie).should eq(movie)
      end
