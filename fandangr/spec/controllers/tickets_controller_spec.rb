  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved ticket as @ticket" do
        ...
        post :create, {:ticket => { "movie_id" => "invalid value" }}, valid_session
        assigns(:ticket).should be_a_new(Ticket)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested ticket" do
        ...
        Ticket.any_instance.should_receive(:update_attributes).with({ "movie_id" => "1" })
        put :update, {:id => ticket.to_param, :ticket => { "movie_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the ticket as @ticket" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Ticket.any_instance.stub(:save).and_return(false)
        put :update, {:id => ticket.to_param, :ticket => { "movie_id" => "invalid value" }}, valid_session
        assigns(:ticket).should eq(ticket)
      end
